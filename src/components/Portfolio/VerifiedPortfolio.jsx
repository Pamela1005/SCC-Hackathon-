          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2 mb-1">
                ...
                <span className="px-3 py-0.5 rounded-full bg-emerald-950/80 border border-emerald-500/40 text-emerald-400 text-xs font-bold flex items-center gap-1">
                  <CheckCircle2 className="w-3.5 h-3.5" /> Recruiter Verified
                </span>
                <span className="px-3 py-0.5 rounded-full bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-xs font-bold">
                  {activeCandidate.percentileRank} Percentile
                </span>
              </div>
